...
OBJS = boot/boot.o kernel/kernel.o kernel/io/serial.o kernel/io/ports.o kernel/cpu/gdt.o kernel/vsprintf.o \
	   ...
	   kernel/tty/backends/vesa_font.o kernel/io/rtc.o \
...
ASM = i686-elf-as
ASM2 = nasm
CXXFLAGS = -ffreestanding -O3 -Wall -Wextra -fno-exceptions -fno-rtti -std=c++14 -Ikernel -Ikernel/lib -fno-omit-frame-pointer $(FLAGS_CXX) $(DRIVERS_FLAGS)
CFLAGS = -ffreestanding -O3 -nostdlib -fno-omit-frame-pointer $(FLAGS_C)
iso: quack.iso
